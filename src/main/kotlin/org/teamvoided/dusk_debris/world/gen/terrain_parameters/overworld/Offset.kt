...
object Offset {
    ...
    fun <C, I : ToFloatFunction<C>> offsetEros(
        ...
        val erosion = CubicSpline.builder(data.erosion, data.amplifier)
    ...
    fun <C, I : ToFloatFunction<C>> offsetBeach(data: TerrainParametersData<C, I>): CubicSpline<C, I> {
        val spline = CubicSpline.builder(data.ridgesFolded, data.amplifier)
            .add(-1f, elev(48))
            .add(-0.4f, 0f)
        return spline.build()
    }
    ...
    fun <C, I : ToFloatFunction<C>> ocean(
        ...
        val trenches = CubicSpline.builder(data.ridgesFolded, data.amplifier)
            .add(trenchBottom)
            .addPoint(-0.4f, addSL(-70) * depthMult, calculateSlope(trenchBottom, trenchTop))
            .add(trenchTop).build()
        val moderate = CubicSpline.builder(data.ridgesFolded, data.amplifier)
        ...
        val ocean = CubicSpline.builder(data.erosion, data.amplifier)
