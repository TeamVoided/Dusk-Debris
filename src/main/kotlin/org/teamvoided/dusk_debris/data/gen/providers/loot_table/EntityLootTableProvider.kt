        ...
        gen.accept(
            ...
            LootTable.builder().pool(
                LootPool.builder().rolls(Utils.constantNum(1))
                    ...
                    .with(
                        LootTableEntry.method_428(DuskLootTables.ENDERMAN_END_GENERIC)
                            .conditionally(
                                LocationCheckLootCondition.builder(
                                    LocationPredicate.Builder.create().method_9024(
                    ...
                    .with(
                        LootTableEntry.method_428(DuskLootTables.ENDERMAN_OVERWORLD_FLOWER).conditionally(
                            LocationCheckLootCondition.builder(
                                LocationPredicate.Builder.create().method_9024(
                    ...
                    .with(
                        LootTableEntry.method_428(DuskLootTables.ENDERMAN_OVERWORLD_ICE).conditionally(
                            LocationCheckLootCondition.builder(
                                LocationPredicate.Builder.create().method_9024(
                    ...
                    .with(
                        LootTableEntry.method_428(DuskLootTables.ENDERMAN_OVERWORLD_DESERT).conditionally(
                            LocationCheckLootCondition.builder(
                                LocationPredicate.Builder.create().method_9024(
                    ...
                    .with(
                        LootTableEntry.method_428(DuskLootTables.ENDERMAN_OVERWORLD_BADLANDS).conditionally(
                            LocationCheckLootCondition.builder(
                                LocationPredicate.Builder.create().method_9024(
