...
//        i: Int
//    ) {
//        super.render(guardianEntity, f, g, matrices, vertexConsumers, i)
//        val livingEntity = guardianEntity.beamTarget
//        if (livingEntity != null) {
//            val h = guardianEntity.getBeamProgress(g)
//            val j = guardianEntity.beamTicks + g
//            val k = j * 0.5f % 1.0f
//            val l = guardianEntity.standingEyeHeight
//            matrices.push()
//            matrices.translate(0.0f, l, 0.0f)
//            val vec3d = this.fromLerpedPosition(livingEntity, livingEntity.height.toDouble() * 0.5, g)
//            val vec3d2 = this.fromLerpedPosition(guardianEntity, l.toDouble(), g)
